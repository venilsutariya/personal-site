...
const Work = () => {
    ...
    return (
        <div className="mt-[100px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-[50px] gap-4 lg:gap-0">
                            ...
                            <div key={index} className="px-4 lg:px-0 overflow-hidden">
                                <div
                                    ...
                                    <img
                                        ...
                                        alt={project.name}
                                        className={`${project.name === 'Finance' ? "": "object-cover"} hover:opacity-80 transition-all imageani cursor-pointer shadow-[#1e1d1d]`}
                                    />
                                ...
                                <div className="py-3 flex flex-wrap gap-x-4 lg:hidden">
